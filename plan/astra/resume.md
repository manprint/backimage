...
tutte le fasi e2e. Run 34442378068 (8c282c4, prima corsa con la fase A6) da seguire. La correzione della sovrapposizione
(unita' 29) e' stata rifatta in 8a72972 dopo che la prima forma era ancora rossa su
`windows` e `macos`: il carico e' ora di due layer, cioe' quanto una pipeline profonda un
layer puo' assorbire.
